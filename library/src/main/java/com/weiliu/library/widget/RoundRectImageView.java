...
public class RoundRectImageView extends ClipPathImageView {
    ...
    public RoundRectImageView(@NonNull Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundRectImageView(@NonNull Context context, @NonNull AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null && mRoundRect.compatible()) {
            ...
            if (theme != null) {
                ...
                mRoundRect.setRoundRadius(a.getDimensionPixelSize(
                        R.styleable.RoundRectImageView_roundRectRadius, mRoundRect.getRoundRadius()), false);
                mRoundRect.setRoundWidth(a.getDimensionPixelSize(
                        R.styleable.RoundRectImageView_roundRectWidth, mRoundRect.getRoundWidth()), false);
                mRoundRect.setRoundHeight(a.getDimensionPixelSize(
                        R.styleable.RoundRectImageView_roundRectHeight, mRoundRect.getRoundHeight()), false);
            }
        }
    ...
    public int getRoundRadius() {
        return mRoundRect.getRoundRadius();
    }
