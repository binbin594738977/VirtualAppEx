...
public abstract class DBHelper extends SQLiteOpenHelper {
    ...
    public SQLiteStatement createInsertStatement(@NonNull String table,
        ...
        values.append(")");
        sql.append(values);
        return getWritableDatabase().compileStatement(sql.toString());
    }

    public SQLiteStatement createDeleteStatement(@NonNull String table,
