...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(@NonNull Context context) {
        ...
        mPaintText.setTextSize(defaultTextSize);
        mPaintText.setAntiAlias(true);
        mPaintFooterLine.setStyle(Paint.Style.FILL_AND_STROKE);
        //noinspection SuspiciousNameCombination
        mPaintFooterLine.setStrokeWidth(mFooterLineHeight);
        mPaintFooterLine.setColor(defaultFooterColor);
        mPaintFooterIndicator.setStyle(Paint.Style.FILL_AND_STROKE);
        mPaintFooterIndicator.setColor(defaultFooterColor);

        final ViewConfiguration configuration = ViewConfiguration.get(context);
        mTouchSlop = ViewConfigurationCompat.getScaledPagingTouchSlop(configuration);
    }

    public TitlePageIndicator(@NonNull Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, R.attr.vpiTitlePageIndicatorStyle);
    }

    public TitlePageIndicator(@NonNull Context context, @NonNull AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        IndicatorStyle style = mFooterIndicatorStyle != null ? mFooterIndicatorStyle : IndicatorStyle.None;
        switch (style) {
            case Triangle:
                mPath.reset();
     ...
     *            width of the view.
     */
    private void clipViewOnTheRight(@NonNull Rect curViewBound, float curViewWidth, int right) {
     ...
     *            width of the view.
     */
    private void clipViewOnTheLeft(@NonNull Rect curViewBound, float curViewWidth, int left) {
     ...
     */
    @NonNull
    private ArrayList<Rect> calculateAllBounds(@NonNull Paint paint) {
     ...
     */
    @NonNull
    private Rect calcBounds(int index, @NonNull Paint paint) {
