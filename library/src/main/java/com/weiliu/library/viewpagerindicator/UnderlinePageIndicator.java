...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(@NonNull Context context) {
        super(context);
    ...
    public UnderlinePageIndicator(@NonNull Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, R.attr.vpiUnderlinePageIndicatorStyle);
    }

    public UnderlinePageIndicator(@NonNull Context context, @NonNull AttributeSet attrs, int defStyle) {
