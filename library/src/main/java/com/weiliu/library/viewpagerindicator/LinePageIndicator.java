...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(@NonNull Context context) {
        super(context);

        final Resources res = getResources();

        mPaintSelected.setColor(res.getColor(R.color.default_line_indicator_selected_color));
        mPaintUnselected.setColor(res.getColor(R.color.default_line_indicator_unselected_color));
        ...
        setStrokeWidth(res.getDimension(R.dimen.default_line_indicator_stroke_width));
    ...
    public LinePageIndicator(@NonNull Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, R.attr.vpiLinePageIndicatorStyle);
    }

    public LinePageIndicator(@NonNull Context context, @NonNull AttributeSet attrs, int defStyle) {
