...
class IcsLinearLayout extends LinearLayout {
    ...
    public IcsLinearLayout(@NonNull Context context, int themeAttr) {
        super(context);
    ...
    @Override
    protected void measureChildWithMargins(@NonNull View child, int parentWidthMeasureSpec,
    ...
    private void drawHorizontalDivider(Canvas canvas, int top) {
        ...
        divider.setBounds(getPaddingLeft() + mDividerPadding, top,
    ...
    private void drawVerticalDivider(Canvas canvas, int left) {
        ...
        divider.setBounds(left, getPaddingTop() + mDividerPadding,
