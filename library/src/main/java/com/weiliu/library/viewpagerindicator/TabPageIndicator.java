...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public TabPageIndicator(@NonNull Context context) {
        this(context, null);
    }

    public TabPageIndicator(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount > 1 && (widthMode == MeasureSpec.EXACTLY || widthMode == MeasureSpec.AT_MOST)) {
            if (childCount > 2) {
                mMaxTabWidth = (int) (MeasureSpec.getSize(widthMeasureSpec) * 0.4f); //SUPPRESS CHECKSTYLE
            } else {
    ...
    public void setOnFragmentChangeListener(OnPageChangeListener listener) {
